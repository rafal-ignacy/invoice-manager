...
class OrderDataHandler:
    ...
    def get_order_details(self, order_dict_flatten: Dict) -> OrderDetails:
        ...
        return OrderDetails(object_dict["order_ebay_id"], object_dict["platform"], object_dict["order_date"], object_dict["payment_status"],
                            object_dict["payment_date"], object_dict["currency"], object_dict["total"], object_dict["delivery_total"])
    ...
    def get_items_details(self, order_dict_flatten) -> List[ItemDetails]:
        ...
        while item_index is not None:
            ...
            for key, value in self.config_data["get_items_details"].items():
                ...
                if order_dict_flatten.get(object_dict_key) is None:
                    item_index = None
                    break
